...
ActiveRecord::Schema[7.0].define(version: 2022_12_14_205925) do
  ...
  create_table "missions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["listing_id", "date", "mission_type"], name: "index_missions_on_listing_id_and_date_and_mission_type", unique: true
